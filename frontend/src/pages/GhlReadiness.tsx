    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Lead capture, qualification, CRM handoff</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        <Card title="Purpose">
          <p className="text-sm text-slate-400">{GHL_READINESS.purpose}</p>
          <div className="mt-4 space-y-2">
            ...
            <div className="flex justify-between text-sm">
              <span className="text-slate-500">Demo State</span>
              <span>{GHL_READINESS.demoState}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-slate-500">Real CRM Writes</span>
        ...
        <Card title="Required Credentials">
          <div className="space-y-3">
            {GHL_READINESS.requiredCredentials.map(cred => (
              <div key={cred.name} className="flex items-center justify-between p-2 bg-slate-900 rounded">
                <div>
      ...
      <Card title="Future Integration Path">
        <div className="font-mono text-sm bg-slate-900 rounded p-4">
