...
describe('Execution Kill Switches', () => {
  it('has all expected kill switches', () => {
    ...
    expect(EXECUTION_KILL_SWITCHES).toContain('GHL_OPERATION_WORKER_ENABLED');
    expect(EXECUTION_KILL_SWITCHES).toContain('GHL_CONTACT_UPSERT_ENABLED');
    expect(EXECUTION_KILL_SWITCHES).toContain('GHL_CONTACT_TAGS_UPDATE_ENABLED');
    expect(EXECUTION_KILL_SWITCHES).toContain('GHL_OPPORTUNITY_UPSERT_ENABLED');
    expect(EXECUTION_KILL_SWITCHES).toContain('GHL_APPOINTMENT_UPSERT_ENABLED');
    expect(EXECUTION_KILL_SWITCHES).toContain('GHL_WHATSAPP_SEND_ENABLED');
    expect(EXECUTION_KILL_SWITCHES).toHaveLength(22);
  });
